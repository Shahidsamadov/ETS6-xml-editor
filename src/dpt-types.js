// KNX DataPoint Type catalogue used by the Group Address Manager.
// Each entry maps a KNX "DPST" identifier (main type - sub type) to its
// symbolic name. Group addresses reference these ids in the "DPTs" attribute
// of the ETS group address export format.
//
// Exposed as window.GAM.DPT_TYPES so the application keeps working without a
// bundler (it can be opened directly from the file system).

window.GAM = window.GAM || {};

window.GAM.DPT_TYPES = Object.freeze([
